...
export function BeliefBlock({
  ...
  return (
    <article
      ...
      className={cn(
        "border-t border-foreground/[0.08] py-12 sm:py-14 lg:py-16",
        hasBody
          ? "grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2 lg:items-start lg:gap-16"
          : undefined,
        className,
      )}
    >
      <h3
        ...
        className={cn(
          ...
          hasBody && reverse && "lg:order-2 lg:text-right",
          !hasBody && "max-w-2xl",
        )}
      >
        {title}
