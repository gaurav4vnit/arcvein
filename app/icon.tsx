...
function Mark() {
  return (
    <svg width="300" height="270" viewBox="0 0 72 64" fill="none">
...
export default function Icon() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", background: "#090B10", borderRadius: 96 }}>
      <Mark />
    </div>,
    size,
  );
